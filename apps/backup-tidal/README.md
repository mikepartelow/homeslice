...
```bash
% export GITHUB_BACKUP_GIT_CLONE_URL=git@github.com:somebody/some-repo.git
% export GITHUB_BACKUP_AUTHOR_NAME='Your Name'
% export GITHUB_BACKUP_AUTHOR_EMAIL='your@email.address'
% make backup
```

A playlist JSON will be downloaded from Tidal, then committed and pushed to
`$GITHUB_BACKUP_GIT_CLONE_URL`.
